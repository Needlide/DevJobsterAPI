...
public class UserSpaceServiceTests : IAsyncLifetime
{
    ...
    public async Task AddMessageToChatAsync_InsertsMessageToChat_AndReturnsOne()
    {
        ...
        AddMessageWithSender addMessage = new(message.MessageId, chatId, "text my message cool", user.UserId, "User", DateTime.UtcNow);
    ...
    public async Task GetMessagesForChatAsync_ExistingId_ReturnsMessages()
    {
        ...
        AddMessageWithSender addMessage = new(message.MessageId, chatId, "Text my message cool", recruiter.RecruiterId, "Recruiter", DateTime.UtcNow);
        AddMessageWithSender addMessage1 = new(message1.MessageId, chatId, "Text my message cool", user.UserId, "User", DateTime.UtcNow);
        AddMessageWithSender addMessage2 = new(message2.MessageId, chatId, "Text my message cool", recruiter.RecruiterId, "Recruiter", DateTime.UtcNow);
